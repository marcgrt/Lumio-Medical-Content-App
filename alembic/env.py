"""Alembic env.py — configured for Lumio SQLModel + SQLite."""
...
# Ensure project root is on sys.path so `from src.models import ...` works
sys.path.insert(0, str(Path(__file__).resolve().parent.parent))

from src.models import SQLModel  # noqa: E402 — import after path setup

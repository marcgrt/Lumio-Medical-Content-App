...
EVIDENCE_TIERS = [
    ...
    (2, "Klinische Studien (RCT & interventionell)",
     ["randomized", "randomised", "rct", "randomized controlled",
      "randomisiert", "randomisierte studie", "clinical trial",
      "interventional", "phase ii", "phase iii", "phase iv"]),
    (3, "Leitlinien & Empfehlungen",
     ["leitlinie", "guideline", "s3-leitlinie", "s3 leitlinie",
      ...
      "consensus", "position statement", "positionspapier"]),
    (4, "Beobachtungsstudien & Register",
     ["cohort study", "cohort", "case-control", "case control",
      ...
      "registerstudie", "real-world", "retrospective"]),
    ...
    (6, "Nachrichten, Berichte & Sonstiges",
     ["news", "press release", "nachricht", "meldung",
      ...
      "preprint", "conference abstract", "kongressbericht"]),
]
